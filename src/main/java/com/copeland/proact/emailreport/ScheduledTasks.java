...
public class ScheduledTasks {
  ...
  @Value("${report.hvac.ccemail:garys.sun@copeland.com}")
  private String ccEmail;

  @Value("${report.hvac.subject:Report - Dollar General HVAC Daily Report}")
  private String subject;

  @Value("${report.hvac.body:Please use this report which is exported from Oracle in case you don't receive DG HVAC report from DOMO!}")
  private String body;
  @Value("${spring.mail.host:INETMAIL.EMRSN.NET}")
...
//                fw.append("\"" + (rs.getString(13) != null ? rs.getString(13) : "") + "\"");
      ...
      sendEmailWithCsvAttachment(toEmail, subject, body, CSV_FILE);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  public void sendEmailWithCsvAttachment(String recipient, String subject, String body, String csvTemplate) {
    try {
      ...
      // Attach the CSV template
      FileSystemResource fileResource = new FileSystemResource(csvTemplate);
      helper.addAttachment("Dollar General HVAC Daily Report.csv", fileResource);
